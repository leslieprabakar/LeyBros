        ...
        <div className="mt-6 grid gap-8 lg:grid-cols-[1.15fr_0.85fr] items-start">
          ...
          <div>
            <h1 className="leading-[0.9]">
              <span className="block font-display text-[48px] sm:text-[72px] font-light tracking-tight text-[#E8D5B5]">LEYBROS</span>
              <span className="block font-display text-[48px] sm:text-[72px] font-semibold tracking-tight text-[#C9A86A] -mt-2">PRIVATE LTD.</span>
              <span className="block mt-3 font-script text-[32px] sm:text-[36px] text-[#C9A86A]/90 leading-none">A freelance technology</span>
              <span className="block font-display text-[20px] sm:text-[24px] font-light tracking-[0.18em] text-zinc-400 mt-1"> & AI CREATIVE PRACTICE</span>
            </h1>
          ...
          <div className="relative">
            ...
            <div className="mt-4 rounded-2xl border border-[#C9A86A]/10 bg-[#10201A]/80 p-5">
              <div className="text-[13px] tracking-[0.14em] text-[#C9A86A]">WHAT VIEWERS FIND FIRST</div>
